...
def contract_classification_train():
    ...
    train_dataset = total_dataset[0:84]
    test_dataset = total_dataset[84:]
    # 获取模型。
    ...
    test_score(test_all_predict_labels, test_all_stand_labels, f"{config.attack_type_name}类型合约级结果", config.attack_type_name)
